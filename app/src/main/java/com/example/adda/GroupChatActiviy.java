...
public class GroupChatActiviy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_chat_activiy);

        currentGroupName = getIntent().getExtras().get("groupName").toString();
        Toast.makeText(GroupChatActiviy.this, currentGroupName, Toast.LENGTH_SHORT).show();
