    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendVerificationCodeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(phoneNumber)) {
                    ...
                    loadingBar.setMessage("Please wait till we send a message to your mobile");
        ...
        verifyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(verificationCode)){
                    ...
                    loadingBar.setMessage("Phone number is verifying, Please wait...");
                    loadingBar.setCanceledOnTouchOutside(false);
                    loadingBar.show();
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                loadingBar.dismiss();
                Toast.makeText(PhoneLoginActivity.this, "Invalid phone number or verification code. Enter phone number with your country code", Toast.LENGTH_SHORT).show();
            ...
            public void onCodeSent(String verificationId, PhoneAuthProvider.ForceResendingToken token) {
                ...
                mResendToken = token;
                Toast.makeText(PhoneLoginActivity.this, "Verification code is sent to your phone number", Toast.LENGTH_SHORT).show();
